...
if uploaded_file is not None:
    try:
        # Lendo com skiprows=8 para pular o cabeçalho técnico do INMET
...
with col1:
    ...
    fig.update_layout(title="Distribuição das Velocidades", xaxis_title="Velocidade (m/s)", yaxis_title="Densidade")
...
with col2:
    ...
    fig_weibull.update_layout(title="Curva Teórica de Weibull", xaxis_title="Velocidade (m/s)", yaxis_title="f(v)")
...
# Cálculo da velocidade média teórica
